...
use VendingMachine\Application\Handler\{CreateCoinHandler, GetMachineHandler, InsertCoinHandler, ReturnCoinHandler};
use VendingMachine\Application\Handler\{CreateMachineHandler};
